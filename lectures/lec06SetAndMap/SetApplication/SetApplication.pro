...
SPL_DIR         =   $${USER_DATA_DIR}/cs106n
STATIC_LIB      =   $$system_path($${SPL_DIR}/lib/libcs106n.a)
...
# link against libcs106n.a, add library headers to search path
# libcs106n requires libpthread, add link here
LIBS            +=  -lcs106n -lpthread
